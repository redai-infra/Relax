...
log-ratio gradient. `exact` remains available to the pure full-vocabulary
verification helper, but production argument validation rejects it because
rollout data stores selected-token log-probabilities rather than behavior logits.
