...
#
# Qwen3-VL-4B 8xGPU colocate training script (aggressive optimization).
# All opts + no recompute + higher sglang mem + larger over-sampling.
#
# Usage:
#   bash scripts/training/multimodal/run-qwen3-vl-4B-8xgpu-aggressive.sh
...
WANDB_ARGS=(
   ...
   --tb-experiment-name qwen3-vl-4b-GRPO-gpu8-aggressive-${now}
)
