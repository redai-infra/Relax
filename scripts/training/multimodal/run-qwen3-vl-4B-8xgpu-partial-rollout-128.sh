...
#
# Qwen3-VL-4B 8xGPU colocate training script (early stopping + sorting + partial rollout).
# Enables fast switching + early stopping + prompt sorting + partial rollout to clip tail.
#
# Usage:
#   bash scripts/training/multimodal/run-qwen3-vl-4B-8xgpu-partial-rollout.sh
...
WANDB_ARGS=(
   ...
   --tb-experiment-name qwen3-vl-4b-GRPO-gpu8-partial-rollout-128-${now}
)
