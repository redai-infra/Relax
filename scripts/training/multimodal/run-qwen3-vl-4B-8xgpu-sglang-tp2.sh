...
#
# Qwen3-VL-4B 8xGPU colocate training script (SGLang TP=2).
# 4 engines x 2 GPUs instead of 8 engines x 1 GPU for faster single-request decode.
#
# Usage:
#   bash scripts/training/multimodal/run-qwen3-vl-4B-8xgpu-sglang-tp2.sh
...
WANDB_ARGS=(
   ...
   --tb-experiment-name qwen3-vl-4b-GRPO-gpu8-sglang-tp2-${now}
)
