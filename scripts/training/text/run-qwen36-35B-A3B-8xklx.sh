...
export RL_MODEL_TYPE="Qwen36_35B_text"
...
export USE_CAST_FC_FUSION=${USE_CAST_FC_FUSION:-1}
EXTRA_ENV_VARS_JSON="\"XMLIR_ENABLE_H2D_SSE_COPY\": \"${XMLIR_ENABLE_H2D_SSE_COPY}\",
